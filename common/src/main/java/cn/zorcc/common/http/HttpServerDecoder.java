...
public final class HttpServerDecoder implements Decoder {
    ...
    private ResultStatus tryDecodeInitial(ReadBuffer readBuffer) {
        ...
        switch (segment) {
            ...
            case MemorySegment a when a == MemorySegment.NULL -> throw new FrameworkException(ExceptionType.HTTP, "Unresolved http method");
            default -> {
    ...
    private ResultStatus tryDecodeUri(ReadBuffer readBuffer) {
        ...
        switch (segment) {
            ...
            case MemorySegment a when a == MemorySegment.NULL -> throw new FrameworkException(ExceptionType.HTTP, "Unresolved http uri");
            default -> {
    ...
    private ResultStatus tryDecodeVersion(ReadBuffer readBuffer) {
        ...
        switch (segment) {
            ...
            case MemorySegment a when a == MemorySegment.NULL -> throw new FrameworkException(ExceptionType.HTTP, "Unresolved http version");
            default -> {
    ...
    private ResultStatus tryDecodeChunkedDataFinal(ReadBuffer readBuffer) {
        ...
        switch (segment) {
            ...
            default -> throw new FrameworkException(ExceptionType.HTTP, "Unresolved http chunked data termination");
        }
    }
    ...
    private ResultStatus tryDecodeChunkedDataLen(ReadBuffer readBuffer) {
        ...
        switch (segment) {
            ...
            case MemorySegment a when a == MemorySegment.NULL -> throw new FrameworkException(ExceptionType.HTTP, "Unresolved http chunked data length");
            default -> {
