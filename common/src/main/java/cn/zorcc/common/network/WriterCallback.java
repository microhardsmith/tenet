...
/**
 *   Writer CallBack interface, could be used for implementing back-pressure or other mechanisms
...
public interface WriterCallback {
     ...
     *   Don't throw an exception in this method or block current thread
     */
    void onSuccess();
