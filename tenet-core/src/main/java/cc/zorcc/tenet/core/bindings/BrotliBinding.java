...
public final class BrotliBinding {
    ...
    static {
        SymbolLookup _ = Dyn.loadDynLibrary(Constants.BROTLI_COMMON);
        SymbolLookup brotliEnc = Dyn.loadDynLibrary(Constants.BROTLI_ENC);
        SymbolLookup brotliDec = Dyn.loadDynLibrary(Constants.BROTLI_DEC);
