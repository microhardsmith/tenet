...
public final class DeflateBinding {
    ...
    static {
        SymbolLookup defalte = Dyn.loadDynLibrary("libdeflate");
        allocCompressor = Dyn.mh(defalte, "libdeflate_alloc_compressor",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        freeCompressor = Dyn.mh(defalte, "libdeflate_free_compressor",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
        allocDecompressor = Dyn.mh(defalte, "libdeflate_alloc_decompressor",
                FunctionDescriptor.of(ValueLayout.ADDRESS));
        freeDecompressor = Dyn.mh(defalte, "libdeflate_free_decompressor",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
        deflateCompress = Dyn.mh(defalte, "libdeflate_deflate_compress",
        ...
        deflateCompressBound = Dyn.mh(defalte, "libdeflate_deflate_compress_bound",
                FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG));
        gzipCompress = Dyn.mh(defalte, "libdeflate_gzip_compress",
                FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG));
        gzipCompressBound = Dyn.mh(defalte, "libdeflate_gzip_compress_bound",
                FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG));
        deflateDecompress = Dyn.mh(defalte, "libdeflate_deflate_decompress",
        ...
        gzipDecompress = Dyn.mh(defalte, "libdeflate_gzip_decompress",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS));
    }
